  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-[var(--transition-smooth)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        scheme: "bg-gradient-secondary text-secondary-foreground hover:shadow-elevated transform hover:scale-[1.02] shadow-card",
        eligible: "bg-eligible text-eligible-foreground hover:bg-eligible/90 shadow-card",
        warning: "bg-warning text-warning-foreground hover:bg-warning/90 shadow-card",
        "not-eligible": "bg-not-eligible text-not-eligible-foreground hover:bg-not-eligible/90 shadow-card",
      },
      size: {
